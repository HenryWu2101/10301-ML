...
#python neuralnet.py small_train_data.csv small_validation_data.csv small_train_out.labels small_validation_out.labels small_metrics_out.txt 1 4 1 0.01